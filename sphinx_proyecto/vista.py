...
vista.py
--------
Configura la ventana con la cual el usuario hara uso de la aplicacion.
"""
...
class Ventana():
    ...
    """
        ...
        Se definen los elementos que permiten la correcta interaccion, como \
        los espacios para completar los campos, la distribucion y los botones,\
        configurados con las funciones correspondientes.
    """
    ...
    def __init__(self, window) -> None:
        ...
        self.autor = tk.Label(self.root, text="Autor\nApellido, Nombre",
                              bg="purple", fg="white")
        ...
        self.isbn = tk.Label(self.root, text="ISBN, \n\
                            978-950-0000-00-0",
                             bg="purple", fg="white")
